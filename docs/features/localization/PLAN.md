...
| | |
|---|---|
| Status | **Phase 0 and Phase 1 are delivered to `main`; revised [Build run 34559082676](https://github.com/ezeellena2/RepositorioBase/actions/runs/34559082676) is green. Phase 2 baseline passed. Shell/`common` is delivered at `554616e`, errors at `1d16fd6`, login at `46f2519`, registration at `16ea18f`, identity context at `22765aa`, credentials at `aaa55cd`, invitations at `c8daeee`, lifecycle at `5a0cc88`, members at `fc6c0f4b`, people at `724a899`, roles at `c9646ed`, sessions at `8f13ea3`, tenants at `10e0826`, PlatformPanel at `42af0a3`, platform shared at `ff859b3`, and platform identities at `cb24e89`. Platform invitations passed its separate verification and is ready for delivery. Existing tests remain unedited and no Spanish translations are added.** |
| Last updated | 2026-09-11 |
| Scope | Backend (.NET), React SPA (`src/Web/ClientApp`), outbox-delivered messages, tests, CI, and the repository's working rules |
| Next action | Commit and push the verified `features/platform/invitations` extraction, then extract `features/platform/retention` (§11.4). |
