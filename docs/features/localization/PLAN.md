...
| | |
|---|---|
| Status | **Phases 0–4 are complete and delivered to `main`, including the Phase 3 copy-review correction at `a271c97` and Phase 4 at `c62b48e`. This post-delivery copy correction is complete and delivered by the commit containing this entry. P5.1–P5.3 are accepted as recommended; Phase 5 implementation is pending and next.** |
...
- A separate post-delivery Phase 3 copy-review correction is delivered at `a271c97`. At that commit, the six broad-context keys
  ...
  delivered by the commit containing this entry: those six values use Workspace/Espacio de trabajo, while stable
...
- The post-delivery copy correction is delivered by the commit containing this entry. The six shared selector and
