...
public class ExistingApplicationRequestAuthorizationTests
{
    ...
    public void RequestInventoryContainsExactlyTheDeclaredRequests()
    {
        ...
        [
            ...
            typeof(CleanArchitecture.Application.IdentityAccess.ExternalLogins.CompleteExternalLoginCommand).FullName,
            typeof(CleanArchitecture.Application.IdentityAccess.ExternalLogins.CompleteExternalLinkCommand).FullName,
            typeof(CleanArchitecture.Application.IdentityAccess.ExternalLogins.CompleteExternalProofCommand).FullName,
            typeof(CleanArchitecture.Application.IdentityAccess.ExternalLogins.ListExternalLoginsQuery).FullName,
            typeof(CleanArchitecture.Application.IdentityAccess.ExternalLogins.UnlinkExternalLoginCommand).FullName,
            typeof(CleanArchitecture.Application.IdentityAccess.Roles.GetPermissionCatalogQuery).FullName,
            typeof(CleanArchitecture.Application.IdentityAccess.Roles.ListRolesQuery).FullName,
            typeof(CleanArchitecture.Application.IdentityAccess.Roles.GetRoleQuery).FullName,
            typeof(CleanArchitecture.Application.IdentityAccess.Roles.CreateRoleCommand).FullName,
            typeof(CleanArchitecture.Application.IdentityAccess.Roles.UpdateRoleCommand).FullName,
            typeof(CleanArchitecture.Application.IdentityAccess.Roles.RetireRoleCommand).FullName,
            typeof(CleanArchitecture.Application.IdentityAccess.Members.ListMembersQuery).FullName,
            typeof(CleanArchitecture.Application.IdentityAccess.Members.ListTenantInvitationsQuery).FullName,
            typeof(CleanArchitecture.Application.IdentityAccess.Members.UpdateMemberRolesCommand).FullName,
            typeof(CleanArchitecture.Application.IdentityAccess.Members.ChangeMemberStatusCommand).FullName,
            typeof(CleanArchitecture.Application.IdentityAccess.Members.TransferOwnershipCommand).FullName,
