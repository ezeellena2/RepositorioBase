...
This repository uses Gentle AI v2.3.0 as its default Codex workflow layer. Every Codex task started in this repository MUST follow the Gentle AI instructions, routing rules, Engram memory protocol, and repository skills defined in this file and under `.agents/skills/`, even when the user does not mention Gentle AI explicitly.
...
- Do not run raw `gentle-ai sync` with Gentle AI v2.3.0 in this repository. Its sync path can apply global scope and modify user-level Codex state. Re-run the explicit workspace installation and compatibility adaptation for upgrades.
