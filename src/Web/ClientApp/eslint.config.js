...
export default [
  ...
  {
    files: ['src/features/identity/context/**/*.{js,jsx}'],
    ignores: ['**/*.test.{js,jsx}', '**/*.spec.{js,jsx}'],
    rules: {
      'i18next/no-literal-string': ['error', {
        mode: 'jsx-only',
  ...
  {
    files: ['src/features/identity/lifecycle/**/*.{js,jsx}'],
    ignores: ['**/*.test.{js,jsx}', '**/*.spec.{js,jsx}'],
    rules: {
      'i18next/no-literal-string': ['error', {
        mode: 'jsx-only',
  ...
  {
    files: ['src/features/identity/members/**/*.{js,jsx}'],
    ignores: ['**/*.test.{js,jsx}', '**/*.spec.{js,jsx}'],
    rules: {
      'i18next/no-literal-string': ['error', {
        mode: 'jsx-only',
  ...
  {
    files: ['src/features/identity/people/**/*.{js,jsx}'],
    ignores: ['**/*.test.{js,jsx}', '**/*.spec.{js,jsx}'],
    rules: {
      'i18next/no-literal-string': ['error', {
        mode: 'jsx-only',
  ...
  {
    files: ['src/features/identity/roles/**/*.{js,jsx}'],
    ignores: ['**/*.test.{js,jsx}', '**/*.spec.{js,jsx}'],
    rules: {
      'i18next/no-literal-string': ['error', {
        mode: 'jsx-only',
  ...
  {
    files: ['src/features/identity/sessions/**/*.{js,jsx}'],
    ignores: ['**/*.test.{js,jsx}', '**/*.spec.{js,jsx}'],
    rules: {
      'i18next/no-literal-string': ['error', {
        mode: 'jsx-only',
  ...
  {
    files: ['src/features/identity/tenants/**/*.{js,jsx}'],
    ignores: ['**/*.test.{js,jsx}', '**/*.spec.{js,jsx}'],
    rules: {
      'i18next/no-literal-string': ['error', {
        mode: 'jsx-only',
  ...
  {
    files: ['src/features/platform/PlatformPanel.jsx'],
    rules: {
      'i18next/no-literal-string': ['error', {
        mode: 'jsx-only',
        'jsx-attributes': {
  ...
  {
    files: ['src/features/platform/shared/**/*.{js,jsx}'],
    ignores: ['**/*.test.{js,jsx}', '**/*.spec.{js,jsx}'],
    rules: {
      'i18next/no-literal-string': ['error', {
        mode: 'jsx-only',
  ...
  {
    files: ['src/features/platform/identities/**/*.{js,jsx}'],
    ignores: ['**/*.test.{js,jsx}', '**/*.spec.{js,jsx}'],
    rules: {
      'i18next/no-literal-string': ['error', {
        mode: 'jsx-only',
