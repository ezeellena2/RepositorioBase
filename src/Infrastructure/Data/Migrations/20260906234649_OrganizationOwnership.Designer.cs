...
namespace CleanArchitecture.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260906234649_OrganizationOwnership")]
    partial class OrganizationOwnership
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("PasswordResetRequests", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_PasswordResetRequests_Lifecycle", "\"Version\" > 0 AND \"ExpiresAt\" > \"IssuedAt\" AND (\"Status\" = 'Pending') = (\"SettledAt\" IS NULL) AND \"TokenHash\" ~ '^v1:[A-Za-z0-9+/]{42}[AEIMQUYcgkosw048]=$'");
                        });
                });
